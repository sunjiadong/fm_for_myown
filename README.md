...
This implemention has used codes of coreylynch [3] for reference and will be used only for my own projects in private.
...
[3] https://github.com/coreylynch/pyFM.git

## Installation
```
pip install git+https://github.com/sunjiadong/fm_for_myown
```
